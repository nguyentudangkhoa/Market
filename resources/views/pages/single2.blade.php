        ...
        <div class="col-md-5 single-right-left ">
            <div class="grid source/images_3_of_2">
                <div class="flexslider">
                    <ul class="slides">
                        <li data-thumb="source/images/se1.jpg">
                            <div class="thumb-image">
                                <img src="source/images/se1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                        </li>
                        <li data-thumb="source/images/se2.jpg">
                            <div class="thumb-image">
                                <img src="source/images/se2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                        </li>
                        <li data-thumb="source/images/se3.jpg">
                            <div class="thumb-image">
                                <img src="source/images/se3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                        </li>
                    </ul>
                ...
                <li>
                    <div class="w3l-specilamk">
                        <div class="speioffer-agile">
                            <a href="single.html">
                                <img src="source/images/s1.jpg" alt="">
                            </a>
                        </div>
